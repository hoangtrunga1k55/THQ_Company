        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('admin.register') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control" placeholder="Please enter your email" value="{{ old('email') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                ...
                <a href="{{ route('admin.showLoginForm') }}" class="text-center">I already have a membership</a>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
